...
import './App.css';
import Header from "./s1_navMenu/Header/Header";
import Main from "./s2_main/Main";
import Skills from "./s3_skills/Skills";
import Slogan from "./s5_slogan/Slogan";
import Contacts from "./s6_contacts/Contacts";
import Footer from "./s7_footer/Footer";
import Projects from "./s4_projects/Projects";
...
class App extends React.Component {
    state = {
        tasks: [
            {
                title: 'REACT',
                description: 'React — это библиотека JavaScript с открытым исходным кодом, которая используется для создания пользовательского интерфейса. Она была создана компанией Facebook и представлена разработчикам в 2013 году.'
            },
            {
                title: 'HTML',
            ...
            {
                title: 'CSS',
                description: 'JavaScript был создан программистом Brendan Eich из Netscape и представлен в декабре 1995 года под названием LiveScript.'
            },
            {
                title: 'TYPESCRIPT',
                description: 'JavaScript был создан программистом Brendan Eich из Netscape и представлен в декабре 1995 года под названием LiveScript.'
    ...
    render = () => {
        ...
        const onSubmit = (name, email, message) => {
            axios.post("https://g-mail-portfolio.herokuapp.com/sendMessage",
                {name, email, message}).then(res => {
